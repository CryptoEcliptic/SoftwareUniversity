namespace SIS.HTTP.Responses
{
    ...
    public class HttpResponse : IHttpResponse
    {
        ...
        {
            if (string.IsNullOrEmpty(cookie.Key) || string.IsNullOrEmpty(cookie.Value)) //TODO Check if validation is needed
            {
        ...
        public override string ToString()
        {
            ...
            {
                output.AppendLine($"Set-Cookie: {this.Cookies.ToString()}"); //TODO Check if tostring is needed
            }
