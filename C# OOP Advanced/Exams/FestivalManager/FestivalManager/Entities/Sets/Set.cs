namespace FestivalManager.Entities.Sets
{
	...
	public abstract class Set : ISet
	{
		...
		public TimeSpan ActualDuration => new TimeSpan(this.Songs.Sum(s => s.Duration.Ticks)); //TODO check if ticks is ok
		...
		public override string ToString() //TODO check to string
		{
