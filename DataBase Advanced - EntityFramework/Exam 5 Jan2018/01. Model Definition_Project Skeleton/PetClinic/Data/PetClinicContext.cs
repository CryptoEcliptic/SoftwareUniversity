namespace PetClinic.Data
{
    ...
    public class PetClinicContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
           ...
           .HasIndex(u => u.PassportSerialNumber)
           .IsUnique();
            ...
            builder.Entity<ProcedureAnimalAid>()
                .HasOne(bc => bc.AnimalAid)
                .WithMany(b => b.AnimalAidProcedures)
                .HasForeignKey(bc => bc.AnimalAidId);

            builder.Entity<ProcedureAnimalAid>()
                 .HasOne(bc => bc.Procedure)
                 .WithMany(b => b.ProcedureAnimalAids)
